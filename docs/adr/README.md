...
If any of the three is missing, the decision belongs in `CONTEXT.md` (if it's a term), `docs/PRD.md` (if it's user-facing scope), `docs/DESIGN.md` (if it's an implementation choice), or code comments — not as an ADR.
